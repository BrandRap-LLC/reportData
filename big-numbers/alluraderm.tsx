...
import {formatCurrency, formatPercentage, getMonthOverMonthChange, getYearOverYearChange, getRetentionRate, getThreeMonthAverage, getThreeMonthChangePercentage, getThreeMonthYoYChangePercentage } from '../src/data/reportData';
import KPICard from '../src/components/KPICard';
import PieChart from '../src/components/PieChart';
import CustomerGrowthChart from '../src/components/CustomerGrowthChart';
import RevenueChart from '../src/components/RevenueChart';
import CustomerValueComparison from '../src/components/CustomerValueComparison';
import RevenueSourceBreakdown from '../src/components/RevenueSourceBreakdown';
import RevenueSourcePercentage from '../src/components/RevenueSourcePercentage';
import RevenueSourceTrend from '../src/components/RevenueSourceTrend';
import QuarterlyComparison from '../src/components/QuarterlyComparison';
import MonthOverMonthHeatmap from '../src/components/MonthOverMonthHeatmap';
import MetricsTable from '../src/components/MetricsTable';
import KeyMetricsSummary from '../src/components/KeyMetricsSummary';
import InsightsRecommendations from '../src/components/InsightsRecommendations';
import NewCustomerTrend from '../src/components/NewCustomerTrend';
import NewCustomerContribution from '../src/components/NewCustomerContribution';
import NewCustomerRevenue from '../src/components/NewCustomerRevenue';
import NewCustomerInsights from '../src/components/NewCustomerInsights';
import NewCustomerKPI from '../src/components/NewCustomerKPI';
import ThreeMonthComparison from '../src/components/ThreeMonthComparison';
import YearOverYearTable from '../src/components/YearOverYearTable';
import YearOverYearChart from '../src/components/YearOverYearChart';
...
type CustomerData = {
  ...
  newCustomerRevenuePercentage: string;
  returningCustomers: number;
  returningCustomerRevenuePercentage: string;
...
const AlluraDerm: React.FC = () => {
  const [reportData, setReport] = useState<ReportData[]>([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("https://dev2.brandrapdev.co/creports/wp-json/client-reports/v1/report?client_url=Alluraderm.com");
        if (!response.ok) throw new Error(`HTTP error! Status: ${response.status}`);

        const result = await response.json();

        // 🔹 Convert API response to match `ReportData` type
        const formattedData: ReportData[] = result.metrices.map((item: CustomerData) => ({
          ...item,
          newCustomerRevenuePercentage: parseFloat(item.newCustomerRevenuePercentage),
          returningCustomerRevenuePercentage: parseFloat(item.returningCustomerRevenuePercentage),
        }));
